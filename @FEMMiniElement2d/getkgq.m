function [kxx,kyy,kxy,kyx,ngleu,nglep,v]=getkgq(t,mele,IEN,X,Y,Z)
...
elseif ( rule == 7 )
    ...
    xtab(1:13) =   [ a, b, c, c, d, e, e, f, g, g, f, h, h ];
    ytab(1:13) =   [ a, c, b, c, e, d, e, g, f, h, h, f, g ];
    ztab(1:13) =   [ a, c, c, b, e, e, d, h, h, f, g, g, f ];
